  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: isMobile ? 6 : 8),
        Text(
          'Prst na čelo ćaci, na zidu si, a voleo bi da nisi!\nDobra vest je da postoji način, loša vest za tebe - nema\n “kozmetike”, zahteva suštinu.Nepoznata teritorija,\n hmmm…jeste, ali ne brini!\nPokaži za početak dovoljno skromnosti da prihvatiš činjenično\n stanje, preuzmi odgovornost za situaciju u kojoj se nalaziš,\n pronađi hrabrosti u sebi za potrebnu inicijativu u delima koja ti\n pomažu da se suočiš sa svim izazovima, i ovo mesto ovde će ti\n ukazati neverovatnu moć izbora!',
